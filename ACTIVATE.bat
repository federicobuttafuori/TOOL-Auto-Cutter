...
rem Step 1: Generate the list of input files
...
rem Step 2: Prepare the FFmpeg command
set "ffmpeg_cmd=ffmpeg -f concat -safe 0 -i concat.txt -c copy output.mp4"

rem Step 3: Execute FFmpeg command
echo Running FFmpeg...
%ffmpeg_cmd%
